...
@EndUserText.label: 'JSTO billingdocument address'
@Metadata.ignorePropagatedAnnotations: true
define view entity ZEINV_BILLADD_JSTO_WE as select from  I_BillingDocumentPartner as bdp
